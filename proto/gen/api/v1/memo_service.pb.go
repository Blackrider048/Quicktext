...
type Memo struct {
	...
	AlarmTime     *timestamppb.Timestamp `protobuf:"bytes,19,opt,name=alarm_time,json=alarmTime,proto3" json:"alarm_time,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Memo) GetAlarmTime() *timestamppb.Timestamp {
	if x != nil {
		return x.AlarmTime
	}
	return nil
...
const file_api_v1_memo_service_proto_rawDesc = "" +
	...
	"createTime:X\xeaAU\n" +
	"\x15memos.api.v1/Reaction\x12!memos/{memo}/reactions/{reaction}\x1a\x04name*\treactions2\breaction\"\xfe\b\n" +
	"\x04Memo\x12\x17\n" +
	...
	"\n" +
	"alarm_time\x18\x13 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x01R\talarmTime\x1a\xac\x01\n" +
	"\bProperty\x12\x19\n" +
...
var file_api_v1_memo_service_proto_depIdxs = []int32{
	...
	37, // 10: memos.api.v1.Memo.alarm_time:type_name -> google.protobuf.Timestamp
