...
const (
	...
	UserSetting_SEARCH_HISTORY UserSetting_Key = 6
)
...
type UserSetting struct {
	...
	//	*UserSetting_SearchHistorySetting_
...
func (x *UserSetting) GetSearchHistorySetting() *UserSetting_SearchHistorySetting {
	if x != nil {
		if x, ok := x.Value.(*UserSetting_SearchHistorySetting_); ok {
			return x.SearchHistorySetting
		}
	}
	return nil
}
...
type UserSetting_SearchHistorySetting_ struct {
	SearchHistorySetting *UserSetting_SearchHistorySetting `protobuf:"bytes,7,opt,name=search_history_setting,json=searchHistorySetting,proto3,oneof"`
}
...
func (*UserSetting_SearchHistorySetting_) isUserSetting_Value() {}
...
type UserSetting_SearchHistorySetting struct {
	state protoimpl.MessageState `protogen:"open.v1"`
...
func (x *UserSetting_SearchHistorySetting) Reset() {
	*x = UserSetting_SearchHistorySetting{}
	mi := &file_api_v1_user_service_proto_msgTypes[49]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *UserSetting_SearchHistorySetting) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UserSetting_SearchHistorySetting) ProtoMessage() {}

func (x *UserSetting_SearchHistorySetting) ProtoReflect() protoreflect.Message {
	mi := &file_api_v1_user_service_proto_msgTypes[49]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UserSetting_SearchHistorySetting.ProtoReflect.Descriptor instead.
func (*UserSetting_SearchHistorySetting) Descriptor() ([]byte, []int) {
	return file_api_v1_user_service_proto_rawDescGZIP(), []int{13, 4}
}

func (x *UserSetting_SearchHistorySetting) GetSearchHistory() []string {
	if x != nil {
...
const file_api_v1_user_service_proto_rawDesc = "" +
	...
	"\x05stats\x18\x01 \x03(\v2\x17.memos.api.v1.UserStatsR\x05stats\"\xac\t\n" +
	...
	"\ftags_setting\x18\x06 \x01(\v2%.memos.api.v1.UserSetting.TagsSettingH\x00R\vtagsSetting\x12f\n" +
	"\x16search_history_setting\x18\a \x01(\v2..memos.api.v1.UserSetting.SearchHistorySettingH\x00R\x14searchHistorySetting\x1a\xab\x01\n" +
	...
	"\bwebhooks\x18\x01 \x03(\v2\x19.memos.api.v1.UserWebhookR\bwebhooks\x1a=\n" +
	"\x14SearchHistorySetting\x12%\n" +
	"\x0esearch_history\x18\x01 \x03(\tR\rsearchHistory\"S\n" +
	"\x03Key\x12\x13\n" +
	"\x0fKEY_UNSPECIFIED\x10\x00\x12\v\n" +
	"\aGENERAL\x10\x01\x12\f\n" +
	"\bWEBHOOKS\x10\x04\x12\b\n" +
	"\x04TAGS\x10\x05\x12\x12\n" +
	"\x0eSEARCH_HISTORY\x10\x06:Y\xeaAV\n" +
...
var file_api_v1_user_service_proto_goTypes = []any{
	...
	(*UserSetting_SearchHistorySetting)(nil),    // 53: memos.api.v1.UserSetting.SearchHistorySetting
...
var file_api_v1_user_service_proto_depIdxs = []int32{
	...
	53, // 19: memos.api.v1.UserSetting.search_history_setting:type_name -> memos.api.v1.UserSetting.SearchHistorySetting
...
func file_api_v1_user_service_proto_init() {
	...
	file_api_v1_user_service_proto_msgTypes[13].OneofWrappers = []any{
		...
		(*UserSetting_SearchHistorySetting_)(nil),
	}
