...
const (
	...
	UserSetting_SEARCH_HISTORY UserSetting_Key = 9
)
...
func (x *UserSetting) GetSearchHistory() *SearchHistoryUserSetting {
	if x != nil {
		if x, ok := x.Value.(*UserSetting_SearchHistory); ok {
...
type UserSetting_SearchHistory struct {
	SearchHistory *SearchHistoryUserSetting `protobuf:"bytes,11,opt,name=search_history,json=searchHistory,proto3,oneof"`
}
...
func (*UserSetting_SearchHistory) isUserSetting_Value() {}
...
type SearchHistoryUserSetting struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *SearchHistoryUserSetting) Reset() {
	*x = SearchHistoryUserSetting{}
	mi := &file_store_user_setting_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SearchHistoryUserSetting) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SearchHistoryUserSetting) ProtoMessage() {}

func (x *SearchHistoryUserSetting) ProtoReflect() protoreflect.Message {
	mi := &file_store_user_setting_proto_msgTypes[8]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SearchHistoryUserSetting.ProtoReflect.Descriptor instead.
func (*SearchHistoryUserSetting) Descriptor() ([]byte, []int) {
	return file_store_user_setting_proto_rawDescGZIP(), []int{8}
}

func (x *SearchHistoryUserSetting) GetSearchHistory() []string {
	if x != nil {
		return x.SearchHistory
	}
	return nil
...
const file_store_user_setting_proto_rawDesc = "" +
	"\n" +
	"\x18store/user_setting.proto\x12\vmemos.store\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x17google/type/color.proto\"\xf0\x05\n" +
	...
	"\x04tags\x18\n" +
	" \x01(\v2\x1c.memos.store.TagsUserSettingH\x00R\x04tags\x12N\n" +
	"\x0esearch_history\x18\v \x01(\v2%.memos.store.SearchHistoryUserSettingH\x00R\rsearchHistory\"\x93\x01\n" +
	"\x03Key\x12\x13\n" +
	...
	"\x04TAGS\x10\b\x12\x12\n" +
	"\x0eSEARCH_HISTORY\x10\tB\a\n" +
	"\x05value\"\x9b\x01\n" +
	...
	"\x0esigning_secret\x18\x04 \x01(\tR\rsigningSecret\"A\n" +
	"\x18SearchHistoryUserSetting\x12%\n" +
	"\x0esearch_history\x18\x01 \x03(\tR\rsearchHistoryB\x9b\x01\n" +
...
var file_store_user_setting_proto_goTypes = []any{
	...
	(*SearchHistoryUserSetting)(nil),                            // 9: memos.store.SearchHistoryUserSetting
...
var file_store_user_setting_proto_depIdxs = []int32{
	...
	9,  // 7: memos.store.UserSetting.search_history:type_name -> memos.store.SearchHistoryUserSetting
