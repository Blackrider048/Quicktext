...
type MemoPayload struct {
	...
	AlarmTime     int64                  `protobuf:"varint,4,opt,name=alarm_time,json=alarmTime,proto3" json:"alarm_time,omitempty"`
...
func (x *MemoPayload) GetAlarmTime() int64 {
	if x != nil {
		return x.AlarmTime
	}
	return 0
...
const file_store_memo_proto_rawDesc = "" +
	...
	"\n" +
	"alarm_time\x18\x04 \x01(\x03R\talarmTime\x1a\xac\x01\n" +
	"\bProperty\x12\x19\n" +
