...
export type UserSetting = Message<"memos.api.v1.UserSetting"> & {
  ...
  value: {
    ...
    /**
     * @generated from field: memos.api.v1.UserSetting.SearchHistorySetting search_history_setting = 7;
     */
    value: UserSetting_SearchHistorySetting;
...
/**
 * User search history configuration.
 *
 * @generated from message memos.api.v1.UserSetting.SearchHistorySetting
 */
export type UserSetting_SearchHistorySetting = Message<"memos.api.v1.UserSetting.SearchHistorySetting"> & {
  /**
   * List of user search history.
   *
   * @generated from field: repeated string search_history = 1;
   */
  searchHistory: string[];
};

/**
 * Describes the message memos.api.v1.UserSetting.SearchHistorySetting.
 * Use `create(UserSetting_SearchHistorySettingSchema)` to create a new message.
 */
export const UserSetting_SearchHistorySettingSchema: GenMessage<UserSetting_SearchHistorySetting> = /*@__PURE__*/
...
export enum UserSetting_Key {
  ...
  /**
   * SEARCH_HISTORY is the key for user search history.
   *
   * @generated from enum value: SEARCH_HISTORY = 6;
   */
  SEARCH_HISTORY = 6,
}
