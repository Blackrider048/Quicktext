...
export type Memo = Message<"memos.api.v1.Memo"> & {
  ...
  /**
   * Optional. The time at which to trigger an alarm/notification.
   *
   * @generated from field: google.protobuf.Timestamp alarm_time = 19;
   */
  alarmTime?: Timestamp | undefined;
};
